...
namespace QL_nhansu.Class
{
    class clsThemUser
    {
        ...
        {
            kn.LoadDGV("select Usename,'*****' as Pass from tblNguoidung", dgv);
        }
        //thu tuc xu ly du lieu
        public void SuaTK(string Tendangnhap, string matkhau)
        {
        ...
        public void NhapTK(string Tendangnhap, string matkhau, int Quyen)
        {
            kn.StoreNone("proc_Taikhoan_Insert", Tendangnhap, matkhau, Quyen);
        }
    }
}
