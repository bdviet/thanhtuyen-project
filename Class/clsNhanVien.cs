...
namespace QL_nhansu.Class
{
    class clsNhanVien
    {
        ...
        {
            kn.LoadDGV("SELECT MaNV,Maphongban,Mato,Machucvu,Ngayvaolam,Thamnien,Heso,Matinhoc,Mangoaingu,Mabangcap,SoBHXH,SoBHYT,Cannang,Cao,Nhommau,Tinhtrangsuckhoe,TaikhoanNH,Madantoc,Matongiao FROM tblNhanvien WHERE MaNV='" + Manv + "'", dgv);
        }
        public void LoadDataGridView_TTThanNhan(DataGridViewX dgv, string Manv)
        {
            kn.LoadDGV("SELECT Mathannhan,Tenthannhan,MaNV,Quanhe,Diachi,Ghichu FROM tblThannhan WHERE MaNV='" + Manv + "'", dgv);
        }
        ...
        public void LoadComboBox_ToLamViec(ComboBoxEx cb)
        {
            kn.LoadDataComboBox_Value("tblTolamviec", "Tento", "Mato", cb);
        }
        ...
        public void ThemNhanVien(string Manv, string Tennv, string CMND, DateTime Ngaycap, string Noicap, DateTime Ngaysinh, string Gioitinh
           , string Nguyenquan, string DCTamtru, string Email,  string DTrieng, string DTnha,string TTHonnhan, string TTLamviec,string Maphong, string Mato, string Machucvu
            ...
            ,string Cannang,string Cao,string Nhommau, string TTsuckhoe, string Sotaikhoan,string Madantoc,string Matongiao)
        {
            kn.StoreNone("proc_NhanVien_Insert", Manv, Tennv, CMND, Ngaycap, Noicap, Ngaysinh, Gioitinh, Nguyenquan, DCTamtru, Email, DTrieng, DTnha
                , TTHonnhan, TTLamviec, Maphong, Mato, Machucvu, Ngayvao, Thamnien, Heso, Tinhoc, Ngoaingu, Hocvi, SoBHXH, SoBHYT, Cannang, Cao, Nhommau, TTsuckhoe,Sotaikhoan,Madantoc,Matongiao);
        }
        ...
        public void SuaNhanVien(string Manv, string Tennv, string CMND, DateTime Ngaycap, string Noicap, DateTime Ngaysinh, string Gioitinh
           ...
           ,   string Maphong, string Mato, string Machucvu, DateTime Ngayvao, int Thamnien, float Heso ,string Tinhoc,string Ngoaingu
        ...
        //Thu tuc them va sua bang than nhan

        public void Them_ThanNhan(string MaTN,string TenTN,string Manv,string Quanhe,string Diachi,string Ghichu)
        {
            kn.StoreNone("proc_ThanNhan_Insert", MaTN,TenTN,Manv,Quanhe,Diachi,Ghichu);
        }
        public void Sua_ThanNhan(string MaTN, string TenTN, string Manv, string Quanhe, string Diachi,string Ghichu)
        {
            kn.StoreNone("proc_ThanNhan_Update", MaTN, TenTN, Manv, Quanhe, Diachi,Ghichu);
        }
        public void Xoa_ThanNhan(string MaTN)
        {
            kn.StoreNone("proc_ThanNhan_Delete",MaTN);
        }
        public int DemDong()
        {
            kn.Open_DB();
            string sql = "SELECT * FROM tblThannhan";
