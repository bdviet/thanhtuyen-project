...
namespace QL_nhansu.Class
{
    class clsData
    {
        static String strCon = @"Data Source=DESKTOP-76NH8MU;Initial Catalog=Quanlynhansu;Integrated Security=True";
        ...
        public static SqlConnection OpenSqlConnection()
        {
            ...
            string strConnect1 = @"Data Source=DESKTOP-76NH8MU;Initial Catalog=Quanlynhansu;Integrated Security=True";
            try
            {
